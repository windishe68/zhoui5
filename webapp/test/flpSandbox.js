		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#atclouddnastudent03zhoui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atclouddnastudent03zhoui5-display": {
								"semanticObject": "atclouddnastudent03zhoui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=at.clouddna.student03.zhoui5",
									"url": sap.ui.require.toUrl("at/clouddna/student03/zhoui5")
								}
							}
						}
					}
